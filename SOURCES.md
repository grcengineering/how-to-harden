...
| Date | Changes |
|------|---------|
| 2026-08-08 | Extended Verification Rule 1's SPA-trap sentence with two named hosts found during the Square and Zendesk currency passes: `squareup.com/help` returns HTTP 200 with the support homepage for article slugs that no longer exist, and `support.zendesk.com/hc` serves a customer sign-in wall to automated fetchers. |
