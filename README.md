...
**Current coverage:**
- 130 hardening guides across 10 categories --- **all 130 `ai-drafted`**, of which **8 also hold `ai-validated`** (Buildkite, Cloudflare, Dropbox, GitHub, Okta, Ona, Stripe, Vercel)
