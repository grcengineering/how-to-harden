...
- **No guide currently holds any `ni-*` status.** All 130 are `ai-drafted`; three (Buildkite, GitHub, Ona) are also `ai-validated`. Never write prose implying a human has reviewed or tested any of it.
