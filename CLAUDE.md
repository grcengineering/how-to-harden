...
- **No guide currently holds any `ni-*` status.** All 130 are `ai-drafted`; eight (Buildkite, Cloudflare, Dropbox, GitHub, Okta, Ona, Stripe, Vercel) are also `ai-validated`. Never write prose implying a human has reviewed or tested any of it.
