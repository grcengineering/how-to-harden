...
| 2026-02-19 | 0.1.1 | ai-drafted | Extract inline code blocks to Code Pack files (sections 4.2, 4.3) | Claude Code (Opus 4.6) |
| 2025-02-05 | 0.1.0 | ai-drafted | Initial guide with workspace security, branch protection, and pipeline security | Claude Code (Opus 4.5) |
